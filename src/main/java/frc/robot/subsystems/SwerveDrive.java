...
public class SwerveDrive extends SubsystemBase {
  ...
  public void setChassisSpeedsPercentage(double forwardPercentage, double sidewaysPercentage, double angularPercentage) {
    setChassisSpeedsVelocity(
        forwardPercentage * kSwerveDrive.MAX_VELOCITY_METERS_PER_SECOND,
        sidewaysPercentage * kSwerveDrive.MAX_VELOCITY_METERS_PER_SECOND, 
        angularPercentage * kSwerveDrive.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND
    );
  }
